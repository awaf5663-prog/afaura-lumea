    ...
    >
      <defs>
        <linearGradient id="lumea-fond" x1="0" y1="0" x2="0.6" y2="1">
          <stop offset="0%" stopColor="#fcf7fa" />
          <stop offset="100%" stopColor="#e5cedb" />
        </linearGradient>
        {/* Ombre portée douce, posée au sol isométrique. */}
        <radialGradient id="lumea-ombre" cx="0.5" cy="0.5" r="0.5">
          <stop offset="0%" stopColor="#5b203f" stopOpacity="0.20" />
          <stop offset="100%" stopColor="#5b203f" stopOpacity="0" />
        </radialGradient>
      </defs>
      ...
      <polyline points="79,117.5 79,143.5" stroke="#8e2961" strokeOpacity="0.5" strokeWidth="2" fill="none" />
      ...
      <polyline points="129,158.5 129,180.5" stroke="#8e2961" strokeOpacity="0.5" strokeWidth="2" fill="none" />
      ...
      <polyline points="63,177.5 63,199.5" stroke="#8e2961" strokeOpacity="0.5" strokeWidth="2" fill="none" />
      ...
      <polygon points="232.0,232.0 294.0,201.0 294.0,149.0 232.0,180.0" fill="#8e2961" />
      <polygon points="232.0,180.0 294.0,149.0 248.0,126.0 186.0,157.0" fill="#a45c6c" />
      {/* Ruban de fermeture, sur les deux faces visibles. */}
      <polyline points="209,168.5 209,220.5" stroke="#fcf7fa" strokeOpacity="0.55" strokeWidth="3" fill="none" />
      <polyline points="263,164.5 263,216.5" stroke="#fcf7fa" strokeOpacity="0.55" strokeWidth="3" fill="none" />
      <polyline points="217,153 240,164.5 263,153" stroke="#fcf7fa" strokeOpacity="0.45" strokeWidth="3" fill="none" strokeLinejoin="round" />
      ...
      <g transform="translate(300 62)">
        <path
          ...
          fill="#8e2961"
        />
        <circle cx="18" cy="18" r="7" fill="#fcf7fa" />
      </g>
      <text
        x="318"
        y="130"
