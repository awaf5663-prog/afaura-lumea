...
export const CATEGORIES: Category[] = [
  ...
  { id: 'voile_mj', name: 'Jersey liquide' },
 ...
 */
  ...
  },
  {
    ...
    price: 2500,
    /* 3 × 1 000 FCFA à l'unité : l'économie est réelle, elle peut s'afficher. */
    compareAtPrice: 3000,
    category: 'lips',
    images: [glossOlibolla],
    variants: [
      {
        name: 'Gloss 1',
        options: [
          'Romantic — Rose subtil',
          'Romantic — Transparent',
          'Romantic — Nude naturel',
          'Romantic — Marron élégant',
          'NYX — Transparent',
          'NYX — Rose subtil',
          'NYX — Marron élégant',
          'Olibolla — 01 Clear',
          ...
          'Olibolla — 08 Berry',
          'Olibolla — 09 Brown',
          'Huile teintée — 01 Nude rosé',
          'Huile teintée — 02 Lilas',
          'Huile teintée — 03 Pêche',
          'Huile teintée — 04 Corail',
          'Huile teintée — 05 Rose bonbon',
          'Huile teintée — 06 Violet',
          'Lip Oil soin — Cannabis Sativa Seed Oil',
          'Lip Oil soin — Cocoa Butter',
          'Lip Oil soin — Hydratant',
        ],
      },
      {
        name: 'Gloss 2',
