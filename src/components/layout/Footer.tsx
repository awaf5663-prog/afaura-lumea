...
const COLUMNS = [
  {
    ...
    links: [
      ...
      { to: '/boutique?famille=voiles', label: 'Voiles' },
      { to: '/boutique?famille=abayas', label: 'Abayas & robes' },
      { to: '/boutique?famille=soins', label: 'Soins' },
      { to: '/boutique?famille=parfums', label: 'Parfums' },
      { to: '/boutique?famille=maquillage', label: 'Maquillage' },
      { to: '/boutique?famille=sacs', label: 'Sacs' },
      { to: '/boutique?famille=chaussures', label: 'Chaussures' },
      { to: '/boutique?famille=nuit', label: 'Nuit & sous-vêtements' },
    ],
  },
  {
    title: 'Services',
