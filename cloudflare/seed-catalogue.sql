-- ═══════════════════════════════════════════════════════════════════
--  Catalogue Afaura Luméa — Cloudflare D1
--
...
insert into products (
  ...
  '[]', '[{"name":"Modèle","options":["Dégradé vert & bleu","Sable pailleté","Noir pailleté","Vert d''eau","Dégradé vert & rouille"],"soldOutOptions":[]}]', '{}',
  null, 'active',
  0, 0,
  1, 0,
  null, '[]'
...
insert into products (
  ...
  0, 0,
  1, 0,
  'jersey23', '[{"label":"Dimensions","value":"170 × 60 cm"}]'
)
on conflict (id) do update set
  slug = excluded.slug,
  name = excluded.name,
...
insert into products (
  ...
  '[]', '[{"name":"Modèle","options":["Zébré bordeaux","Pois sur brun","Pois sur blanc","Aquarelle","Léopard"],"soldOutOptions":[]}]', '{}',
  null, 'active',
  0, 0,
  1, 0,
  null, '[]'
...
insert into products (
  ...
  '[]', '[{"name":"Coloris","options":["Bleu","Gris","Marron","Blanc & noir","Kaki clair — zébré","Kaki","Gris foncé","Gris rose","Café","Noir","Gris clair","Marron clair","Brun rose"],"soldOutOptions":[]}]', '{}',
  null, 'active',
  1, 0,
  1, 0,
  null, '[]'
...
insert into products (
  ...
  '[]', '[{"name":"Coloris","options":["Bleu marine","Bleu canard & rouille","Gris & rose","Kaki & vert olive","Anthracite","Bleu & bleu ciel","Lilas","Orange & violet"],"soldOutOptions":[]}]', '{}',
  null, 'active',
  1, 0,
  1, 0,
  null, '[]'
...
insert into products (
  ...
  '[]', '[{"name":"Teinte","options":["#2 Charcoal black","#3 Navy","#6 Olive grass","#7 Brown","#10 Purple","#11 Sand"],"soldOutOptions":[]}]', '{}',
  null, 'active',
  1, 0,
  1, 0,
  null, '[]'
...
insert into products (
  ...
  '[]', '[{"name":"Dégradé","options":["Gris-bleu & sable","Bordeaux & rose","Violet & crème","Orange & brun"],"soldOutOptions":[]}]', '{}',
  null, 'active',
  1, 0,
  1, 0,
  null, '[]'
...
insert into products (
  ...
  '[]', '[{"name":"Modèle","options":["Noir fleuri","Crème fleuri","Taupe fleuri","Fauve","Écru & or"],"soldOutOptions":[]}]', '{}',
  null, 'active',
  0, 0,
  0, 0,
  null, '[]'
...
Les bics se commandent à la pièce : la photo montre la boîte de 6, mais vous n''en prenez qu''un si vous voulez.',
  550, null, 'rentree',
  '[]', '[{"name":"Modèle","options":["Lot de 6 stylos et souligneurs","Bic bleu","Bic rouge"]}]', '{"Modèle":{"Lot de 6 stylos et souligneurs":550,"Bic bleu":100,"Bic rouge":100}}',
  null, 'draft',
  1, 0,
  0, 0,
  null, '[]'
...
insert into products (
  ...
  1500, null, 'rentree',
  '[]', '[{"name":"Modèle de téléphone","options":["iPhone 11","iPhone 11 Pro Max","iPhone 12","iPhone 12 Pro Max","iPhone 13","iPhone 13 Pro Max","iPhone 14","iPhone 14 Pro Max","iPhone 15","iPhone 15 Pro Max","iPhone 16","iPhone 16 Pro Max","Samsung Galaxy A","Tecno","Infinix","Xiaomi / Redmi","Autre modèle"]}]', '{}',
  null, 'draft',
  1, 0,
  0, 0,
  null, '[]'
...
insert into products (
  ...
  3500, null, 'rentree',
  '[]', '[{"name":"Couleur","options":["Rose","Blanc","Noir"]}]', '{}',
  null, 'draft',
  1, 0,
  1, 0,
  null, '[]'
...
insert into products (
  ...
  10000, null, 'rentree',
  '[]', '[{"name":"Couleur","options":["Blanc","Noir","Rose"]}]', '{}',
  null, 'draft',
  1, 0,
  0, 0,
  null, '[]'
...
insert into products (
  ...
  0, null, 'rentree',
  '[]', '[{"name":"Couleur","options":["Crème","Rose poudré","Lilas"]}]', '{}',
  null, 'draft',
  1, 0,
  1, 0,
  null, '[]'
...
insert into products (
  ...
  11000, null, 'robes',
  '[]', '[{"name":"Couleur","options":["Bleu ciel","Noir","Rouge","Bleu roi","Vert forêt"]}]', '{}',
  null, 'active',
  1, 0,
  1, 0,
  null, '[]'
...
Coloris vus sur le visuel : rose, noir, bleu jean, bleu ciel, vert d''eau, bleu marine. La liste n''y tenait pas en entier — demandez le vôtre, nous confirmons la disponibilité.',
  11000, null, 'robes',
  '[]', '[{"name":"Couleur","options":["Rose","Noir","Bleu jean","Bleu ciel","Vert d''eau","Bleu marine"]}]', '{}',
  null, 'active',
  1, 0,
  1, 0,
  null, '[]'
...
Choisissez la tenue ci-dessus. Pour un coloris absent des photos, dites-le nous : nous confirmons la disponibilité avant paiement.',
  0, null, 'packs',
  '[]', '[{"name":"Tenue","options":["Bold & Sleek","Soft & Flow","Wild & Chic"]}]', '{}',
  null, 'draft',
  1, 0,
  1, 0,
  null, '[]'
...
Choisissez la tenue ci-dessus. Pour un coloris absent des photos, dites-le nous : nous confirmons la disponibilité avant paiement.',
  0, null, 'packs',
  '[]', '[{"name":"Tenue","options":["Bold & Sleek","Soft & Flow","Sweet & Feminine"]}]', '{}',
  null, 'draft',
  1, 0,
  1, 0,
  null, '[]'
...
Choisissez l''ensemble ci-dessus. Pour un coloris absent des photos, dites-le nous : nous confirmons la disponibilité avant paiement.',
  0, null, 'packs',
  '[]', '[{"name":"Ensemble","options":["Chemise blanche + pantalon marron","Chemise à carreaux + pantalon noir","Ensemble bleu top + jupe"]}]', '{}',
  null, 'draft',
  1, 0,
  1, 0,
  null, '[]'
...
Choisissez le trio ci-dessus. Pour un modèle absent des photos, dites-le nous : nous confirmons la disponibilité avant paiement.',
  0, null, 'packs',
  '[]', '[{"name":"Trio","options":["NY Varsity","Legendary 01","Vintage Sport","Athletic Chic","Retro Racing"]}]', '{}',
  null, 'draft',
  1, 0,
  1, 0,
  null, '[]'
...
insert into products (
  ...
  1000, null, 'lips',
  '[]', '[{"name":"Teinte","options":["Transparent","Rose subtil","Marron élégant"]}]', '{}',
  null, 'active',
  1, 0,
  0, 1,
  null, '[]'
...
insert into products (
  ...
  1000, null, 'lips',
  '[]', '[{"name":"Teinte","options":["01 Clear","02 Milky","03 Pink","04 Rose","05 Mauve","06 Nude","07 Red","08 Berry","09 Brown"]}]', '{}',
  null, 'active',
  1, 0,
  0, 1,
  null, '[]'
...
insert into products (
  ...
  1000, null, 'lips',
  '[]', '[{"name":"Teinte","options":["01 Nude rosé","02 Lilas","03 Pêche","04 Corail","05 Rose bonbon","06 Violet"]}]', '{}',
  null, 'active',
  1, 0,
  0, 1,
  null, '[]'
...
insert into products (
  ...
  1500, null, 'bougie',
  '[]', '[{"name":"Parfum","options":["Pink Coconut Matcha Latte","Matcha Latte","Lemon Matcha Latte","Sakura Latte","Lavender Latte","Taro Latte","Caramel Latte","The Iced Coffee"]}]', '{}',
  null, 'active',
  1, 0,
  0, 0,
  null, '[]'
...
insert into products (
  ...
  14000, null, 'sac',
  '[]', '[{"name":"Coloris","options":["Kaki","Écru & noir","Bordeaux","Noir suédine","Noir cuir"],"soldOutOptions":[]}]', '{}',
  null, 'active',
  1, 0,
  1, 0,
  null, '[]'
...
insert into products (
  ...
  0, null, 'gel_douche',
  '[]', '[{"name":"Parfum","options":["Crème de pistache","Grenade & framboise","Fresh & Cozy","Pink Champagne"]}]', '{}',
  null, 'draft',
  1, 0,
  0, 0,
  null, '[]'
...
insert into products (
  ...
  0, null, 'lait_corps',
  '[]', '[{"name":"Senteur","options":["Vanilla Cashmere","Pomegranate Raspberry","Pink Champagne","Jasmine Peach","Strawberry Dream","Crème Pistachio","Fresh & Cozy","Coconut Waters","Beach Waves","Sans parfum"]}]', '{}',
  null, 'draft',
  1, 0,
  0, 0,
  null, '[]'
...
insert into products (
  ...
  '[]', '[{"name":"Coloris","options":["Vache noir et blanc","Léopard","Chocolat","Taupe","Rose vif","Beige"]}]', '{}',
  null, 'active',
  1, 0,
  0, 0,
  null, '[]'
...
insert into products (
  ...
  0, null, 'soin_visage',
  '[]', '[{"name":"Contenance","options":["40 mL","15 mL"]}]', '{}',
  null, 'draft',
  1, 0,
  0, 0,
  null, '[]'
...
insert into products (
  ...
  0, null, 'soin_visage',
  '[]', '[{"name":"Contenance","options":["50 mL","20 mL"]}]', '{}',
  null, 'draft',
  1, 0,
  0, 0,
  null, '[]'
...
insert into products (
  ...
  11500, null, 'gommage',
  '[]', '[{"name":"Parfum","options":["Grenade & lait","Coco & sucre brun","Citron vert & baies"]}]', '{}',
  null, 'active',
  1, 0,
  0, 0,
  null, '[]'
...
insert into products (
  ...
  8000, null, 'parfum',
  '[]', '[{"name":"Senteur","options":["Bare Vanilla","Lovely Sunny"]}]', '{}',
  null, 'active',
  1, 0,
  0, 0,
  null, '[]'
...
insert into products (
  ...
  0, null, 'parfum',
  '[]', '[{"name":"Saveur","options":["Original","Marshmallow","Pistache"]}]', '{}',
  null, 'draft',
  1, 0,
  0, 0,
  null, '[]'
